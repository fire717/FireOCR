...
class YoLov5TRT(object):
    ...
    def __init__(self, engine_file_path):
        ...
        for binding in engine:
            ...
            if engine.binding_is_input(binding):
                self.input_w = 360#engine.get_binding_shape(binding)[-1]
                self.input_h = 40#engine.get_binding_shape(binding)[-2]
    ...
    def infer(self, raw_image_generator):
        ...
        batch_origin_h = []
        batch_origin_w = []
        batch_input_image = np.empty(shape=[self.batch_size, 1, 40, 360])
